...
@implementation HYTopicController

/** 消除编译器警告 */
- (HYTopicType)type {return 0;}
...
- (NSString *)aParam
{
    if ([self.parentViewController isKindOfClass:[HYNewController class]]) {
        return @"newlist";
    } else
    {
        return @"list";
